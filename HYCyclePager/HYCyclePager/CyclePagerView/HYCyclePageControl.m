...
@implementation HYCyclePageControl
...
- (void)setIsPageIndicatorBorderWidth:(BOOL)isPageIndicatorBorderWidth
{
    _isPageIndicatorBorderWidth = isPageIndicatorBorderWidth;
}

- (void)setIsCurrentPageIndicatorBorderColor:(BOOL)isCurrentPageIndicatorBorderColor
{
    _isCurrentPageIndicatorBorderColor = isCurrentPageIndicatorBorderColor;
}
...
- (void)setPageIndicatorBorderWidth:(CGFloat )pageIndicatorBorderWidth
{
    _pageIndicatorBorderWidth = pageIndicatorBorderWidth;
    [self updateIndicatorViewsBehavior];
}

- (void)setPageIndicatorBorderColor:(UIColor *)pageIndicatorBorderColor
{
    _pageIndicatorBorderColor = pageIndicatorBorderColor;
    [self updateIndicatorViewsBehavior];
}
- (void)setCurrentPageIndicatorWidth:(CGFloat)currentPageIndicatorWidth
{
    _currentPageIndicatorWidth = currentPageIndicatorWidth;
    [self updateIndicatorViewsBehavior];
}
    ...
    for (UIImageView *indicatorView in _indicatorViews) {
        if (_pageIndicatorImage) {
            ...
            if (_currentPage == index) {
                ...
                if (_isPageIndicatorBorderWidth) {
                    indicatorView.layer.borderWidth = _currentPageIndicatorWidth;
                }
                if (_isCurrentPageIndicatorBorderColor) {
                    indicatorView.layer.borderColor = _currentPageIndicatorBorderColor.CGColor;
                }
            }else{
                if (_isPageIndicatorBorderWidth) {
                    indicatorView.layer.borderWidth = _pageIndicatorBorderWidth;
                }
                if (_isCurrentPageIndicatorBorderColor) {
                    indicatorView.layer.borderColor = _pageIndicatorBorderColor.CGColor;
                }
            }
        }
